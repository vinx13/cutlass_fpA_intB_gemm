...
void preprocess_weights(int8_t* preprocessed_quantized_weight, const int8_t* row_major_quantized_weight, size_t num_experts, size_t rows,
    size_t cols, bool is_int4, int arch)
{
    ...
    preprocess_weights_for_mixed_gemm(
        preprocessed_quantized_weight, row_major_quantized_weight, shape, qtype, arch);
}
